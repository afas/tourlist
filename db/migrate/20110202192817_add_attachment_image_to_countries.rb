class AddAttachmentImageToCountries < ActiveRecord::Migration
  def self.up
    add_column :countries, :image_file_name, :string
    add_column :countries, :image_content_type, :string
    add_column :countries, :image_file_size, :integer
    add_column :countries, :image_updated_at, :datetime
  end
